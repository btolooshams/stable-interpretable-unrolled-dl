...
def main():
    ...
    #
    X_train = torch.zeros(
        (params["train_num"], params["num_ch"], params["patch_size"], params["patch_size"]), device=device
    )
    ...
    X_test = torch.zeros(
        (params["test_num"], params["num_ch"], params["patch_size"], params["patch_size"]), device=device
    )
